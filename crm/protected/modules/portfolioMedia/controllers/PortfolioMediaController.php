 ...
 */
class PorfolioMediaController extends x2base {

    public $modelClass = "PorfolioMedia";
    ...
    public function actionUpload(){
        $model = new PorfolioMedia;

        if(isset($_POST['PorfolioMedia'])){
            ...
            $model->associationType = $_POST['PorfolioMedia']['associationType'];
            $model->associationId = $_POST['PorfolioMedia']['associationId'];
            $model->private = $_POST['PorfolioMedia']['private'];
            $model->path; // File type setter is embedded in the magic getter for path
            $model->name = $_POST['PorfolioMedia']['name'];
            if (empty($model->name))
                $model->name = $model->fileName;
            if($_POST['PorfolioMedia']['description'])
                $model->description = $_POST['PorfolioMedia']['description'];
