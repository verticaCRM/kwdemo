...
<div id="listingDetails-form"
    ...
    $columns = array(
        array(
            'name'=>'id',
            'type'=>'raw',
            'header' => Yii::t("contacts", 'ID'),
            'value' => 'CHtml::link($data->id,Yii::app()->createUrl("clistings",array($data->id=>"")),array("target"=>"_blank"))',
        ),
        array(
            'name'=>'c_name_dba_c',
            'type'=>'raw',
            'header' => Yii::t("contacts", 'Listing'),
            'value' => 'CHtml::link($data->c_name_dba_c,Yii::app()->createUrl("clistings",array($data->id=>"")),array("target"=>"_blank"))',
        ),
        array(
            'name' => 'assignedTo',
        ...
        array(
            'name' => 'createDate',
            'header' => Yii::t('contacts', 'Activated Date'),
