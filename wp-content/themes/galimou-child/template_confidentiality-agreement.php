<?php
/*
Template Name: Confidentiality Agreement
*/
...
<?php echo do_shortcode('[listmenu menu="Sub Conf Agreement" menu_id="sub_conf_agreement" menu_class="au_submenu"]');?>
	...
	<div class="portfolio_group">
		<div class="container-fluid search_result">
			<div class="row searchpage_main_content_row">
				...
				<div  id="business_container" class="col-12 col-sm-8 col-lg-9 searchlists_container" style="float: none;">
