<?php
/*
Template Name: Cont+2Images+Id+BusSearch+BusMenu 
*/
session_start();
//ini_set('display_errors',true);
//error_reporting(E_ALL);

//for page Businesses for Sale->For Sale By Industry => we need only Businesses available for sale NOT the sold ones
