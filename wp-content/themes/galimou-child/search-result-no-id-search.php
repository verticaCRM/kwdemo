<?php
/*
Template Name: Search_Results_1Img_0Id_BusMenu
*/
session_start();
//ini_set('display_errors',true);
//error_reporting(E_ALL);

//for page Businesses for Sale->The Corporate Collection => we need only Businesses available for sale NOT the sold ones
