<?php
/*
Template Name: Cont+2Images+Id+BusSearch+ContactMenu 
*/
session_start();
...
if(isset($_REQUEST["c_businesscategories"]) && !empty($_REQUEST["c_businesscategories"])){
	...
	foreach($_REQUEST["c_businesscategories"] as $businesscategory) {
...
<?php echo do_shortcode('[listmenu menu="Sub Contact" menu_id="sub_contact" menu_class="au_submenu"]');?>
...
?>  
 ...
 <div style="vertical-align:bottom;display: inline-block;" class="col-lg-12">
