...
<div id="form1" style="display: block;"><form action="/buyer-profile/" method="post">
...
<p><label for="c_cellphone">Cell Phone: </label><input id="c_cellphone" class="wpcf7-form-control" name="c_cellphone" size="40" type="tel" value="" /></p>
...
<p><label for="c_phone2">Work Phone:</label><input id="c_phone2" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-tel" name="c_phone2" size="40" type="tel" value="" /></p>
...
<input class="brokerprofilebutton" type="submit" value="Save Changes" />
...
userobj = jQuery.parseJSON('<?php echo addslashes($userjson);?>');
...
get_footer();
//get_template_part('template','bottom');
?>
